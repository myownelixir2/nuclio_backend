...
class TestSequenceConfigRefactor(unittest.TestCase):
    ...
    def test_get_note_sequence(self, mock_get_job_params, mock_extract_note_sequence):
        ...
        mock_get_job_params.return_value = {
            "local_paths": "assets/sounds/PITCH_C__BPM_120__nn2_120_drum_loop_inland_full.mp3",
...
class TestSequenceAudioFrameSlicer(unittest.TestCase):
    ...
    def setUp(self, mock_load):
        ...
        self.mock_sequence_config.job_params.get_job_params.return_value = {
            "local_paths": "path/to/audio.wav"
        }
    ...
    def test_get_audio_frame_sequence_list(self, mock_load):
        ...
        self.mock_sequence_config.get_audio_frames_length.return_value = [
            11025.0,
            5512.5,
            5512.5,
            11025.0,
        ...
        expected_result = [
            ...
            np.array([0, 11025, 22050, 33075, 44100, 55125, 66150, 77175, 88200, 99225]),
        ]
...
class TestSequenceEngine(unittest.TestCase):
    @patch(
        "app.sequence_generator.generator.SequenceConfigRefactor"
    )  # Replace with the actual module where SequenceConfig is defined
    @patch(
        "app.sequence_generator.generator.SequenceAudioFrameSlicer"
    )  # Replace with the actual module where AudioFrameSlicer is defined
    ...
    def setUp(self, mock_pitch_shift, mock_random_choice, mock_config, mock_frames):
        ...
        self.mock_config.get_audio_frames_length.return_value = np.array(
            [44100, 88200, 132300]
        )
    ...
    @patch.object(SequenceAudioFrameSlicer, "get_audio_frames")
    def test_generate_audio_sequence(
        self,
        mock_get_audio_frames,
        mock_get_note_sequence,
        mock_get_audio_frames_length,
        mock_load,
    ):
        ...
        # Mocking get_audio_frames_length return value
        mock_get_audio_frames_length.return_value = [
            11025.0,
            5512.5,
            5512.5,
            11025.0,
        ...
        # Mocking get_audio_frames return value
        mock_get_audio_frames.return_value = [
            [np.random.rand(10) for _ in range(5)],
            [np.random.rand(20) for _ in range(5)],
        ]
...
class TestAudioEngine(unittest.TestCase):
    ...
    def test_save_to_mp3(self, mock_AudioSegment):
        ...
        mock_AudioSegment_instance.export.assert_called_once_with(
            "dummy/path", format="mp3", bitrate="128k"
        )
...
class TestJobRunner(unittest.TestCase):
    ...
    def setUp(self, mock_job_config, mock_storage_engine):
        ...
        self.mock_job_config.return_value.path_resolver.return_value = {
    ...
    def test_validate(
        self, mock_sequence_engine, mock_audio_frame_slicer, mock_sequence_config
    ):
        mock_instance = mock_sequence_engine.return_value
        mock_instance.generate_audio_sequence.return_value = (
            "validated_audio_sequence",
            "audio_sequence",
        )
    ...
    def test_execute(self, mock_audio_engine):
        with patch.object(self.job_runner, "get_assets") as mock_get_assets, patch.object(
            ...
            mock_audio_engine.assert_called_with(
                "audio_sequence",
                self.mock_job_config.return_value.path_resolver.return_value[
